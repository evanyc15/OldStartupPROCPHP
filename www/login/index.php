...
require("../../assets/php/login/header.php"); //this file has a mysqli_close() in it already!
		...
		<div style='position: relative;'>
			<form action="php/login.php" id="signup-form" class="form-horizontal" method="POST" onsubmit="return validateForm_login()">
				...
				<div style="text-align: center; padding-bottom: 12px;">
					<span id="user-password-error" style='position: relative;  text-align: center;color: #B80000; display: none;'><i>Incorrect email or password</i></span>
				</div>
