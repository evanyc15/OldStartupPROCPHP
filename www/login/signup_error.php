...
require("../../assets/php/login/signup_error.php"); //this file already has a mysqli_close()
...
<body class="page-full-width">
	...
	<!-- BEGIN CONTAINER -->
	<div class="row-fluid">
		<div id='outer' class="span12">
								
									<div id='login-box1'>
										<div style='position: relative;'>
											
											<form action="php/signup.php" id="signup-form" class="form-horizontal" method="POST" onsubmit="return validateForm_signup()">
												<h2 style='position: relative; text-align: center; padding-top: 8px; margin-bottom: -13px;'>Sign-Up <span style='font-size: 14px;'>Make sure to fill out every field</span></h2>
												<h5 style='position: relative;  text-align: center;color: #B80000;'><i >That email has already been used!</i></h5>
												<div class="control-group">
													<label id='text-me' class="control-label">First Name</label>
													<div class="controls" style='position: relative;'>
														<input id='firstname' type="text" placeholder="Fist name..." class="m-wrap medium" name='firstname'/>
												...
												<div class="control-group">
													<label id='text-me-2' class="control-label"> <a href='#' >Terms & Conditions</a></label>
						...
						<div class="portlet box blue tabbable">
							<div class="portlet-title">
								<div class="caption">
									...
									<span class="hidden-480">Sign In</span>
								</div>
							</div>
								...
								<div class="tabbable portlet-tabs">
											...
											<form action="#" class="form-horizontal">
												...
												<div class="control-group" style='padding: 30px;'>
													...
													<div class="controls">
														<input type="text" placeholder="Email..." class="m-wrap medium" />
													</div>
												</div>
